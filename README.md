...
**A Computational Social Science Research Project**

---

🎓 *M.Tech Data Science & Artificial Intelligence*  
🏛 *Indian Institute of Technology Madras – Zanzibar Campus (IITMZ)*  
📅 *January 2026*
...
Social media platforms are no longer neutral spaces for political discussion.  
They actively **shape political visibility** through algorithmic ranking systems.

This project investigates **how political content spreads on Instagram and YouTube in Tamil Nadu**, focusing on:

- What types of political content exist  
- How people react to different content  
- How algorithms amplify certain narratives  
- What this means for democratic discourse and elections  

This is a **research-grade, reproducible, and transparent analysis** built using real data and interpretable methods.

---

## 🎯 Research Questions

1. What types of political content are shared on Instagram and YouTube?
2. How does the public engage with different political content types?
3. Do social media algorithms amplify some political narratives more than others?
4. Can algorithmic amplification indirectly influence elections in Tamil Nadu?
...
```text
tn_politics_algorithmic_analysis/
│
├── data/
│   ├── instagram_clean.csv
│   ├── youtube_clean.csv
...
│   ├── amplification_index.py
│   ├── interpretation.py
│   └── visualization/
│       ├── content_typology_plot.py
│       ├── engagement_plots.py
│       └── amplification_plot.py
│
├── figures/
│   ├── Figure_1.jpeg
│   ├── Figure_2.jpeg
